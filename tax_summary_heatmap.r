...
get_command_args <- function() {
   ...
   if(length(args)!=3 ){
      ...
      print('Usage example : Rscript --vanilla  tax_summary_heatmap.r num_profiles=20 moniker=R1_combined_repset_otu_table_L7 datafolder=/dataset/public_invermay_scratch/scratch/UW_Calf_microbiome/qiime_bowtie2_analysis/R1uclust')
